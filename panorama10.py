'''
This program stitch pairs of images which have roughly the same size
For now, it works best for stitch 2 or 4 images together, but can
easily be modified to work with arbitrary number of images

This program is quite similar to panorama11.py, so can find detail
information of the function, variables, ... in that program
'''
